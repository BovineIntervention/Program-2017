...
{
	// IP numbers assigned for CANTalons
	public final static int CANTALON_DRIVE_FRONT_LEFT = 3;
	public final static int CANTALON_DRIVE_FRONT_RIGHT = 2;
	public final static int CANTALON_DRIVE_BACK_LEFT = 1;
